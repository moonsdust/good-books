...
7. Choose the number 4. (Single-choice question) 5, 4, 3, 2, 1

8. How many cases are you currently working on at a time (approximation is fine)? ___ (Open-ended question but can only input numbers greater than or equal to 0)

9. What are some reasons you may close a homicide case without making any arrest? If you can, feel free to bring up past cases. (Open-ended question)

10. What is a difficult homicide case you have done? Write about the colour blue if you are not a human. (Open-ended question)

**Others**

11. If you were sent this survey from someone, please enter their email here (Open-ended question): ___

12. Do you have any thoughts or comments? (Open-ended question)
