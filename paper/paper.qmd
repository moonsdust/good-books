...
The data we used for this paper comes from The Washington's Post's GitHub repository, "How The Post mapped unsolved murders" also known as the "Unsolved Homicide Database" [@datahomicides]. For the entirety of the paper, we used the statistical programming language R [@citeR]. We also used 
