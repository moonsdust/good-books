...
- TODO: 
- A sense of the dataset should be communicated to the reader. [Done]
- The broader context of the dataset should be discussed. [Done]
- Explain if there were similar datasets that could have been used and why they were not. [Done] 
...
- Summary statistics should also be included, and well as any relationships between the variables. [Done]
...
#| tbl-cap: Data type, number of observations, minimum, maximum, median, mean, 1st and 3rd quartile of variables in dataset on solved and unsolved homicides 
#| echo: false
#| warning: false
#| message: false
