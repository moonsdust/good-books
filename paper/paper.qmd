---
title: "My title"
subtitle: "An analysis of solved and unsolved homicides from 2007 to 2017 in the United States's 2 largest cities"
author: 
  - Emily Su
...
#| tbl-cap: Relationship between a homicide being unsolved from 2007 to 2017 with the city and date (month, year) a victim is found in/on and the race, age, and sex of a victim with their mean absolute deviation (MAD) values in parenthesis    
#| echo: false
#| warning: false
#| message: false
...
modelsummary(
  ...
  list("Unsolved homicides (2007 to 2017)" = unsolved_model_results),
...
#| fig-cap: The credible intervals (line) for coefficient estimates (dot) of predictors of homicides that go unsolved from 2007 to 2017
#| echo: false
#| warning: false
#| message: false
